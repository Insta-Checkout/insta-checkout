...
## Dev Server
```
npm run dev:checkout   # port 3001
```
...
- Used by one page → colocate in that page's folder
- Used by 2–3 pages → move to closest common parent
- Used across features → `components/` central directory
